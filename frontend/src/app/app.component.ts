...
@Component({
  ...
  template: `
    <app-toast-container />
    <div
      class="flex h-screen w-full overflow-hidden bg-slate-50 dark:bg-[#09090b]"
    >
      <!-- Sidebar -->
      <aside
        class="flex w-64 flex-col border-r border-slate-200/60 bg-white/70 backdrop-blur-xl dark:border-slate-800/60 dark:bg-slate-900/40"
      >
        <div class="flex h-16 flex-shrink-0 items-center px-6">
          <a class="flex items-center gap-3" routerLink="/tasks">
            <div
              class="grid size-9 place-items-center rounded-xl bg-gradient-to-br from-brand-500 to-brand-700 font-bold text-white shadow-lg shadow-brand-500/25"
            >
              <svg
        ...
        <nav class="flex-1 space-y-1 px-3 py-4 overflow-y-auto">
          ...
          >
            <svg
              class="mr-3 h-5 w-5 opacity-70 group-[.nav-item-active]:opacity-100"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
